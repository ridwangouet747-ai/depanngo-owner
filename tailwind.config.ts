    ...
    extend: {
      colors: {
        ...
        brand: {
          ...
          "danger-soft": "hsl(var(--brand-danger-soft))",
          warning: "hsl(var(--brand-warning))",
          "warning-soft": "hsl(var(--brand-warning-soft))",
          info: "hsl(var(--brand-info))",
          "info-soft": "hsl(var(--brand-info-soft))",
        },
        gray: {
          50: "hsl(var(--gray-50))",
      ...
      boxShadow: {
        "glow-primary": "0 0 30px hsl(var(--brand-primary) / 0.35)",
